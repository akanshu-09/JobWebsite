...
<nav class="navbar navbar-expand-lg navbar-light" style="background-color: #f0d9b5 ;">
    <div class="container">
        <a class="navbar-brand fs-1 fw-medium" href="#">SpaceX Job Portal Web App</a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item"><a class="nav-link" href="https://www.spacex.com/">Contact</a></li>
            </ul>
        </div>
    </div>
</nav>
